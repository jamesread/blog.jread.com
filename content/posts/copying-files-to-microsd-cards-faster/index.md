...
tags:
  - USB
featured_image_credit: Image by Pexels from Pixabay
featured_image_url: https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=1841254
---

I've been doing tech for... quite a while now, but it's important to be humble and admit when the simple things catch you out. Today, a simple task of copying files to a MicroSD taught me to pay attention to the details. All I was doing was copying some video files back onto a MicroSD card, from my Linux workstation. It's an exfat filesystem, so `-a` sprews errors with rsync;
...
The first line is the root hub, which is USB 2.0 - admitidly a black USB port on the back of the moterhboard. 
